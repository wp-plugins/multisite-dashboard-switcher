...
The Multisite Dashboard Switcher is a plugin written for WordPress that allows multisite administrators
...
* Fixed: Issue with detection of Network Admin URL
